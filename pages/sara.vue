<template>
  ...
  export default {
    ...
    head: {
      title: 'Volkwagen Strategy and Risk Analysis',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: '8 min read — A VW group-wide solution to analyse and mitigate effects of geopolitical events by combining VW group internal and external data'
        },{
          hid: 'keywords',
          name: 'keywords',
          content: 'volkwagen, vw, geopolitics, geopolitic risks, victor vernilli, user-centered design'
        },{
          hid: 'author',
          name: 'author',
        ...
        // Facebook metadata
        {
          ...
          hid: 'og:title',
          property: 'og:title',
          content: 'Volkwagen Strategy and Risk Analysis | Victor Vernilli'
        },{
          hid: 'og:site_name',

  ...
  <transition name="fade" mode="out-in">
    <div :key="currentLocale" class="project-page">
      <div class="project-page__hero desktop-image mb-4">
        <img :src="require(`~/static/img/portfolio/${$t('projects[4].heroImg')}`)" alt="" class="w-100 h-100">
        <h1 class="project-page__title text-center">
          {{ $t('projects[4].projectTitle') }}
        </h1>
      </div>
      ...
      <main>
        ...
        <project-page-main
          :content="$t('projects[4].projectContent', { returnObjects: true })"
      ...
      <div class="project-page__other-projects container">
        ...
        <portfolio-showcase :hideProject="$t('projects[4].permalink')" />
      </div>
...
export default {
  ...
  computed: {
    ...
    pageContent: function() {
      return this.$i18n.messages[this.$i18n.locale].projects[4].projectContent
    },
  ...
  mounted() {
    this.visibleItemNav = this.$i18n.messages[this.$i18n.locale].projects[4].visibleItemNav
  }
}
</script>
